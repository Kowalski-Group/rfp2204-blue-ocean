...
export default function Avatar() {
  ...
  const updateAvatar = (video, positions) => {
    ...
    faceEl.style.transform = `translate3d(${
      nosePoint.x - midX + faceRect.width / 4
    }px, ${nosePoint.y - midY + faceRect.height / 4}px, 0)`;
  ...
  return (
    <div className="relative w-[720px] h-[560px] mx-auto">
      ...
      <div
        ref={face}
        className="absolute top-36 left-0 right-0 mx-auto bg-indigo-700 w-44 h-60 rounded-full transition-all duration-500 ease-in-out border-4 border-indigo-100 overflow-hidden"
      >
        {/* hair */}
        ...
        {/* left eye */}
        <div className="absolute top-1/4 left-6 bg-indigo-100 w-12 h-12 rounded-full border-2 border-indigo-100 flex items-center justify-center z-10">
          <div
            ref={leftEyebrow}
        ...
        {/* right eye */}
        <div className="absolute top-1/4 right-6 bg-indigo-100 w-12 h-12 rounded-full border-2 border-indigo-100 flex items-center justify-center">
          <div
            ref={rightEyeBrow}
            className="absolute h-4 w-8 -top-4 left-0 right-0 mx-auto bg-indigo-100 rounded-full border-2 border-indigo-700 transition-all duration-500 ease-in-out"
          />
